...
use OC\WebAgencyBundle\Entity\NewsLetter;
...
class NewsLetterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $newsLetters = $em->getRepository('OCWebAgencyBundle:NewsLetter')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OC\WebAgencyBundle\Form\NewsLetterType', $newsLetter);
    ...
    {
        $deleteForm = $this->createDeleteForm($newsLetter);
        $editForm = $this->createForm('OC\WebAgencyBundle\Form\NewsLetterType', $newsLetter);
