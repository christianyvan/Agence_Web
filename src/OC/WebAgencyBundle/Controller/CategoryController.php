...
use OC\WebAgencyBundle\Entity\Category;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('OCWebAgencyBundle:Category')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OC\WebAgencyBundle\Form\CategoryType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('OC\WebAgencyBundle\Form\CategoryType', $category);
